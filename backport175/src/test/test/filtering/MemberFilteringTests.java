 ...
 */
public class MemberFilteringTests extends TestCase {
    ...
    public MemberFilteringTests(String name) {
        super(name);
    }
...
//    }
    ...
    public static junit.framework.Test suite() {
        return new junit.framework.TestSuite(MemberFilteringTests.class);
    }
}
