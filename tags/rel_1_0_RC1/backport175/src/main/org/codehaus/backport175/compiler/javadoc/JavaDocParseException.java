 ...
 */
public class JavaDocParseException extends RuntimeException {
    /**
     ...
     */
    public JavaDocParseException(final String message) {
        super(message);
    }
     ...
     */
    public JavaDocParseException(String message, Throwable throwable) {
        super(message);
